...
function Subscription_VeggieSection({ addToCart }) {
    ...
    const products = [
        { productID:'Ve01' ,name: 'Carrots', quantity: carrotQuantity, price: 50, image: '/carrot.png', setQuantity: setCarrotQuantity },
        { productID:'Ve02' ,name: 'Broccoli', quantity: broccoliQuantity, price: 80, image: '/broccoli.png', setQuantity: setBroccoliQuantity },
    ];
