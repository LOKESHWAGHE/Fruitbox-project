...
//     const clearCart = () => {
//         const subsId = localStorage.getItem('subscriptionID'); // Retrieve the subscription ID from local storage
...
//             // Optionally clear any other related data in localStorage
//         })
//         .catch(error => {
